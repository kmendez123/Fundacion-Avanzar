...
class DBR_Advanced_DB_Reset {
	...
	public function __construct(){
		...
		if(!defined("DBR_PLUGIN_VERSION")) 	define("DBR_PLUGIN_VERSION", "1.7");
	...
	function DBR_load_styles_and_scripts($hook){
		...
		wp_localize_script('DBR_js', 'DBR_ajax_obj', array(
			...
			'warning_msg' 	 	=> __('You are about to reset your database!', 'advanced-wp-reset'),
					...
					<tr style="background:#fff;border:0px solid #eee;">
						...
						<td width="100%">
							<div style="background:#fff;padding:10px;margin-bottom:10px;">
								<?php
								$DBR_plugin_title = "Advanced WP Reset";
								?>
								...
								<div style="border-top:1px dashed #eee;padding-top:4px">
									...
									&nbsp;|&nbsp;
									<span class="DBR-row-text"><?php _e('Version', 'advanced-wp-reset'); ?></span>
									<?php echo "<b>" . DBR_PLUGIN_VERSION . "</b>" ?>
								</div>
							</div>
						</td>
